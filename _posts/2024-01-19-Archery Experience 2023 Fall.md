...
last_modified_at: 2024-01-19 12:52:07 +0800
...
另外，射到箭靶上的分數也要記錄，每次練習一局[^fn1]的得分是多少(我1/18在18米射大靶一局才59分哈哈)，記錄下來才能看見自己的成長，自信也是一個好的射手重要能力的一環。
...
除了上面說的這些之外，還有夾箭片之類的裝備，也有和射擊不直接相關的器材，例如修箭用的器材、測量磅數用的儀器等。
